...
(function() { this.JST || (this.JST = {}); this.JST["templates/persons/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('\n');  for(var index in persons) { ; __p.push('\n<p>Name:</p>\n<p>',  persons[index].name ,'</p>\n<p>',  persons[index].register_number ,'</p>\n',  persons[index].image ,'\n');  }  ; __p.push('\n');}return __p.join('');};
}).call(this);
(function() {
 "use strict";
